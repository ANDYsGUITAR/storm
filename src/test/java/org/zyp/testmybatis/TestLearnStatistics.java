...
//  }  
    ...
    public void test1() {  
       int booknum;
       String learntime;
    	List<LearnStatisticsPojo> list=new ArrayList<LearnStatisticsPojo>();
    	String account_no="a1015088819";
    //	list=this.service.allStatistics(account_no);
//        list=service.selectByAccount(account_no);
//        booknum=service.learnBookNum(account_no);
//        learntime=service.sumLearnTime(account_no);
//        System.out.println(booknum+"***"+learntime);
