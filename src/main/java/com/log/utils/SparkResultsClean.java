...
public class SparkResultsClean {
	...
	public static void sparkClean(String[] args) throws Exception {
      ...
      //获得输入参数 [hdfs://localhost:9000/user/hadoop/input, hdfs://localhost:9000/user/hadoop/output]
        ...
        job.setJarByClass(SparkResultsClean.class);
        // 设置Map和Reduce处理类
...
/*****************************************分析类的实现************************************************/
    ...
    public static void main(String[] args) throws ParseException {
    	/**例子**/
        final String S1 = "[syz120160195,1e2e7c0d94ee46d380607df8ad73db17,7.344999999999999]";
